...
namespace NIJ.Web.Migrations
{
    ...
    [Migration("20231004101750_users")]
    partial class users
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Modelo.Cadastros.ActivityUser", b =>
                {
                    b.Property<long?>("ActivityId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Modelo.Cadastros.Project", b =>
                {
                    ...
                    b.Property<string>("FotoMineType")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("NIJ.Web.Models.Infra.UserAplication", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("NIJ.Web.Models.Infra.UserAplication", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Modelo.Cadastros.ActivityUser", b =>
                {
                    b.HasOne("Modelo.Cadastros.Activity", "Activity")
                        .WithMany("ActivitiesUsers")
